...
-- Open parent dir
vim.keymap.set("n", "-", H.netrw_parent_dir, { desc = "" })
...
-- Visual manipulation
vim.keymap.set("x", "<leader>,", H.split_inline_args, { desc = "Split inline args to multiline" })
...
-- Ctags
vim.keymap.set("n", "<leader>C", H.generate_ctags, { desc = "Generate Ctags" })
